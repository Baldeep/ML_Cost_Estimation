...
public class CostEstimationMMREFitness extends GPFitnessFunction {
	...
	Logger log = Logger.getLogger(CostEstimationMMREFitness.class);
	
	public CostEstimationMMREFitness(List<List<Double>> inputs, List<Double> outputs, List<Variable> variables) {
	...
	protected double evaluate(IGPProgram program) {
	        ...
	        for (int i = 0; i < dataLen; i++) {
        		...
        		result += Math.abs(value - outputs.get(i))/outputs.get(i);
	        }
